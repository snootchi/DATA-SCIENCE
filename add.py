...
image = Image.open(r'C:\Users\user\OneDrive\Bureau\logo.png')
st.image(image, use_column_width=True)
st.caption('Powered By : **BUILDIG**')
st.title('Analyse Des Données')
st.markdown("""
Cette Web Application est dédiée pour faire les différentes opérations dans l'**ADD** Ainsi les Analyses Statistiques ,
* Cette Web Application a été faite par **RABIA MAHDI SALAH EDDINE** par le langage de programmation **PYTHON**.
***
""")
data = st.file_uploader('Entrer les données en format EXCEL ')
